...
CREATE USER IF NOT EXISTS 'todolistsecond'@'localhost' IDENTIFIED WITH mysql_native_password BY 'ArchidepMbo1+';

GRANT ALL PRIVILEGES ON todolist.* TO 'todolistsecond'@'localhost' ;
